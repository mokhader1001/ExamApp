...
<div class="row justify-content-center">
    <div class="col-lg-7">
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
            <div class="card-header bg-expert-blue py-5 position-relative">
                <div class="position-absolute bottom-0 start-50 translate-middle-x mb-n5 text-center">
                    <img src="https://ui-avatars.com/api/?name=<?= urlencode($user['full_name']) ?>&background=6366f1&color=fff&size=128"
            ...
            <div class="card-body pt-5 mt-4">
                ...
                <p class="text-muted small mb-4 text-uppercase fw-bold text-center"><?= $user['role'] ?></p>
                        ...
                        <form action="<?= site_url('profile/updateSecurity') ?>" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" name="current_password" class="form-control rounded-3"
                                    placeholder="Verify your current identity" required>
                            </div>
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-danger py-2 border-0"
                                    style="background: #ef4444;">Update Password</button>
                            </div>
                        </form>
                    </div>
                </div>
